...
echo "DATASET_ID=$DATASET_ID MODALITY=$MODALITY TARGET=$TARGET"
echo "RAW=$nnUNet_raw"
...
echo ">>> Preprocessing done for Dataset${DATASET_ID}"
srun nnUNetv2_plan_and_preprocess -d ${DATASET_ID} --verify_dataset_integrity
